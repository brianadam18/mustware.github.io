...
$pdf->Image('logo/must.png',1,1,2,2);
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'Must Ware',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 082257453113',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL.Soekarno Hatta No.9 Malang - Jawa Timur',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Email : mustware@mustware.com',0,'L');
...
$pdf->ln(0.8);
$pdf->Cell(5,0.7,"Nama : $nama ",0,0,'L');
$pdf->ln(0.5);
$pdf->Cell(5,0.7,"Alamat : $alamat ",0,0,'L');
$pdf->ln(0.6);
