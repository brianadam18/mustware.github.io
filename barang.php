...
if (isset($_POST['btn-save'])) {
	...
	if ($barang->tambah($nama_brg,$gambar,$jenis,$suplier,$harga_modal,$harga_jual,$jumlah,$deskripsi)) {
...
<div class="container">
	<!-- <div class="row"> -->
			...
			while ($row=$stmt->fetch(PDO::FETCH_ASSOC)) {
				if ($row['jumlah']<=5) {
			echo "<div style='padding:5px' class='alert alert-warning'><span class='glyphicon glyphicon-info-sign'></span> Masukkan  <a style='color:red'>". $row['nama_brg']."</a> data dengan benar . lengkapi data yang kurang !!</div>";
				}
			}
			?>
