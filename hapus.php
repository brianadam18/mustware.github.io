...
<div class="container">
 ...
 else
 {
  ?>
     ...
     <strong>Yakin ?</strong> untuk menghapus data berikut ? 
  </div>
        <?php
 }
 ?> 
...
if(isset($_GET['hapus_id']))
{
 ?>
   <form method="post">
    ...
    <button class="btn btn-large btn-primary" type="submit" name="btn-del"><i class="glyphicon glyphicon-trash"></i> &nbsp; Iya</button>
    <a href="barang.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; Tidak</a>
    </form>  
 <?php
}
else
{
 ?>
    <a href="barang.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; Kembali ke Barang</a>
    <?php
}
?>
</p>
