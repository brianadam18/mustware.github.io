...
if (isset($_POST['btn-update'])) {
	...
	$sisa ='';
	if ($barang->updateku($id,$nama_brg,$gambar,$jenis,$suplier,$harga_modal,$harga_jual,$jumlah,$deskripsi,$sisa)) {
...
<div class="panel-heading"><h4><i class="glyphicon glyphicon-edit"></i> Ubah Data Barang</h4></div>
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
			<input type="text" name="deskripsi" class="form-control" placeholder="Deskripsi .." value="<?php echo $suplier; ?>">
			</div>
		</div>
